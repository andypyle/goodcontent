...
if (checkRoute('/pages/create')) {
		(0, _jquery2.default)(document).ready(function () {
				...
				pageNameField.on('keyup', function (e) {
						return slugField.val('/' + slugify(e.target.value));
				});
...
exports.uploadFile = function uploadFile(e) {
	...
	var fileUploader = $(this).siblings('.Form__FileUpload__Clickable');
...
exports.selectType = function selectType(e) {
	var valueField = $(this).parent().siblings('.Field__Value');
