...
// Slug handler (https://gist.github.com/mathewbyrne/1280286)
...
var addRow = require('./pages.addrow.js').addRow;
var delRow = require('./pages.delrow.js').delRow;
var selectType = require('./pages.selecttype.js').selectType;
var slugify = require('./helper.slugify.js');
...
if (checkRoute('/pages/create')) {
	(function () {
		var uploadFile = require('./pages.fileupload.js').uploadFile;

		(0, _jquery2.default)(document).ready(function () {
			// Automatically fill slug field with slugified name.
			var pageNameField = (0, _jquery2.default)('.js-pagename');
			var slugField = (0, _jquery2.default)('.js-pageslug');
			...
			var formRows = (0, _jquery2.default)('.js-formrows');

			// Select type event
			var selectTypeField = (0, _jquery2.default)('.js-selecttype');
			formRows.on('change', '.js-selecttype', selectType);

			// Add row button
			var addRowBtn = (0, _jquery2.default)('.js-addrow');

			// Delete row button
			var delRowBtn = (0, _jquery2.default)('.js-delrow');
			...
			form.on('submit', function (e) {
				e.preventDefault();
				console.log((0, _jquery2.default)(this).serialize());
...
},{"./helper.slugify.js":1,"./pages.addrow.js":3,"./pages.delrow.js":4,"./pages.fileupload.js":5,"./pages.selecttype.js":6,"jquery":7}],3:[function(require,module,exports){
'use strict';
...
exports.delRow = function (e) {
	...
	e.preventDefault();
	(0, _jquery2.default)(this).parent().parent().slideUp(350, function () {
		return (0, _jquery2.default)(_this).parent().parent().remove();
	});
};
...
exports.uploadFile = function (e) {
	var uploadPrompt = confirm('Are you sure you want to upload: \n' + e.target.value + '?');
	var data = new FormData();
	var file = this.files[0];
	data.append('image', file);

	var fileUploader = (0, _jquery2.default)(this).siblings('.Form__FileUpload__Clickable');
	var progressBar = fileUploader.children('.Form__FileUpload__Progress');
	var progressText = fileUploader.children('.Form__FileUpload__ButtonText');
	var buttonIcon = fileUploader.children('.fa');
	var hiddenValue = fileUploader.children('.Form__FileUpload__HiddenValue');
	var widthOfUploadButton = fileUploader.width();
	...
	if (uploadPrompt) {
		_jquery2.default.ajax({
			...
			success: function success(dataReturned) {
				...
				window.setTimeout(function () {
					progressText.animate({
						...
						progressText.html(dataReturned.filename).animate({
							opacity: 1
						}, 400, function () {
...
exports.selectType = function (e) {
	var valueField = (0, _jquery2.default)(this).parent().siblings('.Field__Value');
	var currentRow = (0, _jquery2.default)(this).parent().parent();
